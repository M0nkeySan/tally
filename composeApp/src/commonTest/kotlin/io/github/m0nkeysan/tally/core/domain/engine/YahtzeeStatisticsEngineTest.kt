...
private fun createUpperSectionScores(
    ...
    return listOf(
        createTestScore(
            gameId = gameId,
            playerId = playerId,
            category = YahtzeeCategory.ACES,
            score = acesScore
        ),
        createTestScore(
            gameId = gameId,
            playerId = playerId,
            category = YahtzeeCategory.TWOS,
            score = twosScore
        ),
        createTestScore(
            gameId = gameId,
            playerId = playerId,
            category = YahtzeeCategory.THREES,
            score = threesScore
        ),
        createTestScore(
            gameId = gameId,
            playerId = playerId,
            category = YahtzeeCategory.FOURS,
            score = foursScore
        ),
        createTestScore(
            gameId = gameId,
            playerId = playerId,
            category = YahtzeeCategory.FIVES,
            score = fivesScore
        ),
        createTestScore(
            gameId = gameId,
            playerId = playerId,
            category = YahtzeeCategory.SIXES,
            score = sixesScore
        )
    )
}
...
class CalculateUpperBonusRate {
    ...
    fun `returns 0 percent when no games are finished`() {
        ...
        val scores = createUpperSectionScores(
            gameId = "game1", acesScore = 5, twosScore = 10,
            threesScore = 15, foursScore = 16, fivesScore = 20, sixesScore = 18
        ) // Total = 84
    ...
    fun `returns 100 percent when all games achieve bonus`() {
        ...
        val scores = createUpperSectionScores(
            ...
            threesScore = 15, foursScore = 16, fivesScore = 20, sixesScore = 18
                ...
                createUpperSectionScores(
                    gameId = "game2", acesScore = 5, twosScore = 10,
                    threesScore = 15, foursScore = 16, fivesScore = 20, sixesScore = 18
                ) // Total = 84
    ...
    fun `returns 0 percent when no games achieve bonus`() {
        ...
        val scores = createUpperSectionScores(
            gameId = "game1", acesScore = 1, twosScore = 2,
            threesScore = 3, foursScore = 4, fivesScore = 5, sixesScore = 6
        ) + // Total = 21
                createUpperSectionScores(
                    gameId = "game2", acesScore = 2, twosScore = 4,
                    threesScore = 6, foursScore = 8, fivesScore = 10, sixesScore = 12
                ) // Total = 42
    ...
    fun `calculates correct percentage for partial achievement`() {
        ...
        val scores = createUpperSectionScores(
            ...
            threesScore = 15, foursScore = 16, fivesScore = 20, sixesScore = 18
                ...
                createUpperSectionScores(
                    gameId = "game2", acesScore = 1, twosScore = 2,
                    threesScore = 3, foursScore = 4, fivesScore = 5, sixesScore = 6
                ) + // Total = 21 ✗
                createUpperSectionScores(
                    gameId = "game3", acesScore = 3, twosScore = 10,
                    threesScore = 12, foursScore = 12, fivesScore = 15, sixesScore = 11
                ) + // Total = 63 ✓
                createUpperSectionScores(
                    gameId = "game4", acesScore = 2, twosScore = 4,
                    threesScore = 6, foursScore = 8, fivesScore = 10, sixesScore = 12
                ) // Total = 42 ✗
    ...
    fun `correctly sums upper section categories only`() {
        ...
        val scores = createUpperSectionScores(
            gameId = "game1", acesScore = 3, twosScore = 10,
            threesScore = 12, foursScore = 12, fivesScore = 15, sixesScore = 11
        ) + // Total = 63
                listOf(
                    createTestScore(
...
class SectionAverages {
    ...
    fun `excludes lower section from upper average`() {
        // Given
        val scores = createUpperSectionScores(
            acesScore = 5, twosScore = 10, threesScore = 15,
