...
object AppStrings {
    ...
    const val GAME_DELETE_ALL_CONFIRM =
    ...
    const val CD_TAROT_ICON = "Tarot"
    const val CD_FINISHED_GAME = "Finished game"
    ...
    const val DIALOG_DELETE_COUNTER_MESSAGE =
